    ...
    <div class="row px-xl-5 pb-3">
        ...
        <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
            <div class="card product-item border-0 mb-4">
                <div class="card-header product-img position-relative overflow-hidden bg-transparent border p-0" style="height: 250px; width: 100%;">
                    <img class="img-fluid h-100 w-100 object-fit-cover" src="{{\Storage::url($item->image)}}" alt="">
                </div>

...
@section('content')
<h2 class="text-center">Cập nhật :{{$product->name}}</h2>
    ...
    <div class="row">
      <div class="col-md-6">
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control" id="name" name="name" {{ old('name')}} value="{{$product->name}}">
          @error('name')
        ...
        <div class="mb-3">
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control" id="" name="slug" {{ old('slug')}} value="{{$product->slug}}" >
            @error('slug')
             <span class="text-danger">{{ $message }}</span>
            @enderror
          </div>
      ...
      <div class="col-md-6">
        ...
        <div class="mb-3">
          ...
          <input type="number" class="form-control" id="phone" name="price_regular" {{ old('price_regular')}} value="{{$product->price_regular}}">
          @error('price_regular')
           <span class="text-danger">{{ $message }}</span>
          @enderror
        </div>
        <div class="mb-3">
            ...
            <input type="number" class="form-control" id="" name="price_sale" {{ old('price_sale')}} value="{{$product->price_sale}}">
            @error('price_sale')
             <span class="text-danger">{{ $message }}</span>
            @enderror
          </div>
          <div class="mb-3">
            ...
            <input type="description" id="" name="description" class="form-control" value="{{$product->description}}">
          </div>
          <div class="mb-3">
            <label for="" class="form-label">Content</label><br>
            <textarea name="content" id="" cols="70" rows="4" value="{{$product->content}}"></textarea>
          </div>
      </div>
    </div>
